...
function fiveDay(lat, lon, date){
  ...
  .then( function(data){
      ...
      $(".date1").text(date1);
      $(".temp1").text("Temp:" +((("Temp: "+ data.daily[0].temp.day- 273.15) * 9/5) + 32).toFixed(2)+ "F");
      ...
      $(".date2").text(date2);
      $(".temp2").text("Temp:" +((("Temp: "+ data.daily[1].temp.day- 273.15) * 9/5) + 32).toFixed(2)+ "F");
      ...
      $(".date3").text(date3);
      $(".temp3").text("Temp:" +((("Temp: "+ data.daily[2].temp.day- 273.15) * 9/5) + 32).toFixed(2)+ "F");
      ...
      $(".date4").text(date4);
      $(".temp4").text("Temp:" +((("Temp: "+ data.daily[3].temp.day- 273.15) * 9/5) + 32).toFixed(2)+ "F");
      ...
      $(".date5").text(date5);
      $(".temp5").text("Temp:" +((("Temp: "+ data.daily[4].temp.day- 273.15) * 9/5) + 32).toFixed(2)+ "F");
